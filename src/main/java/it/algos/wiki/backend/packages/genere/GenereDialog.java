...
public class GenereDialog extends CrudDialog {
     ...
     */
    public GenereDialog(final Genere entityBean, final CrudOperation operation, final CrudBackend crudBackend, final List fields) {
